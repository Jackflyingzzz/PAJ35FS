...
def resume_env(plot=False,  # To plot results (Field, controls, lift, drag, rec area) during training
    ...
    def _init():
        ...
        number_steps_execution = int((
                                                 simulation_duration / dt) / nb_actuations)  # Duration in timesteps of action interval (Number of numerical timesteps over which NN action is kept constant, control being interpolated)
